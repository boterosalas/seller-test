...
let productionVersion = 1;
/* If the release is in production, the version is number 2 */
if (isProductionEnv) {
    productionVersion = 2;
}
...
export const defaultVersion = {
    prefix: 'v',
    number: productionVersion
};

export const endpoints = {
    // endpoints QA version
    v1: {
        // orders
        ...
        validateSellerNit: 'https://5avfpnwghf.execute-api.us-east-1.amazonaws.com/ValidateSellerNit',
    ...
    v2: {
        ...
        getSellerCommissionCategory: 'https://lp04fcggo3.execute-api.us-east-1.amazonaws.com/sellercommissioncategory-pdn',
        // Register seller services
        registerSeller: 'https://x2vflz270c.execute-api.us-east-1.amazonaws.com/registerseller-pdn',
        validateSellerNit: 'https://ce8fuvj37h.execute-api.us-east-1.amazonaws.com/validatesellernit-pdn',
        ...
        // Cities and States services
        getCities: 'https://lcdy1iepcf.execute-api.us-east-1.amazonaws.com/cities-pdn/',

...
@Component({
  selector: 'app-download-products-seller',
  templateUrl: './download-products-seller.component.html',
  styleUrls: ['./download-products-seller.component.scss']
})
export class DownloadProductsSellerComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DownloadProductsSellerComponent>,
   ...
   * @memberof DownloadProductsSellerComponent
   */
  sendExportProducts() {
    ...
    this.productsService.sendEmailExportProductsSeller(dataToSend).subscribe((res: any) => {
      if (res != null) {
        if (res.data === true) {

...
import { DownloadProductsSellerComponent } from './download-products-seller.component';
...
describe('DownloadProductsSellerComponent', () => {
  let component: DownloadProductsSellerComponent;
  let fixture: ComponentFixture<DownloadProductsSellerComponent>;
  ...
  const mockListProductService = jasmine.createSpyObj('ListProductService', ['sendEmailExportProductsSeller']);
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [DownloadProductsSellerComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DownloadProductsSellerComponent);

...
export class ProductBasicInfoComponent implements OnInit {
     ...
     */
    colorList = [
        { Name: this.languageService.getValue('secure.products.bulk_upload.beige'), color: '#F5F5DC', border: '#e2e1c8', hexColorCode: 16185047 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.black'), color: '#000000', border: '#000000', hexColorCode: 0 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.white'), color: '#FFFFFF', border: '#bdbdbd', hexColorCode: 16777215 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.blue'), color: '#03A9F4', border: '#8282f9', hexColorCode: 255 },
        { Name:  this.languageService.getValue('secure.products.bulk_upload.yellow'), color: '#FEEA3A', border: '#cece00', hexColorCode: 16776960 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.brown'), color: '#4E342E', border: '#3E2723', hexColorCode: 6830601 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.gray'), color: '#37474F', border: '#565656', hexColorCode: 9803157 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.green'), color: '#2E7D32', border: '#1B5E20', hexColorCode: 32768 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.orange'), color: '#FF8F00', border: '#FF6F00', hexColorCode: 16750899 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.pink'), color: '#E91E63', border: '#C2185B', hexColorCode: 15572666 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.purple'), color: '#6639B6', border: '#670167', hexColorCode: 8388736 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.red'), color: '#c62828', border: '#b71c1c', hexColorCode: 16711680 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.silver'), color: '#BDBDBD', border: '#9E9E9E', hexColorCode: 12632256 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.golden'), color: '#FFB300', border: '#FFA000', hexColorCode: 15590005 },
        { Name: this.languageService.getValue('secure.products.bulk_upload.multicolored'), color: '#FFB300', border: '#bdbdbd', hexColorCode: 986895, multicolor: true },
    ];

    public UnitMeasurementList = [this.languageService.getValue('secure.products.bulk_upload.gram'), this.languageService.getValue('secure.products.bulk_upload.mililitre'), this.languageService.getValue('secure.products.bulk_upload.metre'), this.languageService.getValue('secure.products.bulk_upload.Unit')];
    validateRegex: any;
    newForm: any;
    valInputEan: any;
    ...
    config: AngularEditorConfig = {
        ...
        height: '15rem',
        minHeight: '5rem',
        placeholder: this.languageService.getValue('secure.products.bulk_upload.write_description_here'),
        translate: 'no',
        customClasses: [
          {
            name: 'quote',
    ...
    public saveKeyword(): void {
        ...
        if (word) {
            ...
            if (this.keywords.length < 20) {
                ...
                this.snackBar.open(this.languageService.getValue('secure.products.bulk_upload.only_up_to_20_keywords'), 'Cerrar', {
                    duration: 3000,
                });
            }
        }
    ...
    public addSon(): void {
        if (this.validarNewSon()) {
            ...
            this.snackBar.open(this.languageService.getValue('secure.products.bulk_upload.order_to_add_necessary'), this.languageService.getValue('actions.close'), {
                duration: 3000,
            });
        }
    }

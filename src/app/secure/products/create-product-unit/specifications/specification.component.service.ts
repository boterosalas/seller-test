...
export class SpecificationService {
    ...
    structureJson = {
        statusCode: 200,
        status: 200,
        body: { body: '{ "Data": ' + this.specification + ' } ' }
    };
     ...
     */
    public getSpecifications(): Observable<SpecificationModel[]> {
        return of(this.specificationModel.changeJsonToSpecificationModel(this.specification));
    }
}

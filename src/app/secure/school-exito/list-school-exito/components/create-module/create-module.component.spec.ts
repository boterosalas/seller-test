...
//     mockschoolExitoService.createModules.and.returnValue(of(createModule));
//     component.createModules();
//     expect(mockschoolExitoService.createModules).toHaveBeenCalled();
//   });

...
//     component.createSubModule.controls.subModuleName.setValue('prueba');

//     spyOn(component.dialogRef, "close").and.callThrough();
//     mockschoolExitoService.createSubModules.and.returnValue(of(createSubModule));
//     component.createSubModules();
//     expect(mockschoolExitoService.createSubModules).toHaveBeenCalled();
//   });

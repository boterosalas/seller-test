...
//     component.formEditModule.controls.SubModuleName.setValue("prueba");
...
//     mockschoolExitoService.editSubModules.and.returnValue(of(editSubModule));
//     component.editModule();
//     expect(mockschoolExitoService.editSubModules).toHaveBeenCalled();
//   });

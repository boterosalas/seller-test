...
import { DownloadHistoricalService } from '@app/secure/offers/historical-admin/download-historical-modal/download-historical.service';
...
export class DownloadHistoricalModalAdminModule {
}
